...
export const systemPermissions = ['admin', 'maintainer', 'user'] as const;
export const systemRoles = systemPermissions;
export const userStatuses = ['active', 'disabled'] as const;
export const projectPermissions = ['manage', 'maintain', 'normal'] as const;
